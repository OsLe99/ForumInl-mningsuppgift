...
namespace ForumInlämningsuppgift.Areas.Identity.Pages.Account
{
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (Input.ProfileImage !=null && Input.ProfileImage.Length > 0)
                {
                    ...
                    var uniqueFileName = Guid.NewGuid().ToString() + "_" + Input.ProfileImage.FileName;
                ...
                user.ProfileImage = imagePath ?? "/images/profile/default.jpeg";

                if (user is ForumUser forumUser)
                {
                    forumUser.Nickname = Input.Nickname;
                    forumUser.ProfileImage = imagePath;
                }
